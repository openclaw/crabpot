...
const consumerFiles = [
  ...
  "scripts/resource-failure-diagnostic.mjs", "scripts/import-screening.mjs", "scripts/resource-workloads/paired-node.mjs",
];
...
function verifyReceiptPins(report, pins) {
  assert.equal(report.provenance.diagnosticsSha256, pins.files.crabpot["scripts/resource-failure-diagnostic.mjs"], "Receipt diagnostic helper differs");
