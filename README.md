...
- **Last dashboard update:** May 04, 2026, 11:25 UTC
...
- **GitHub report run:** [25316095666](https://github.com/openclaw/crabpot/actions/runs/25316095666)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2468ms / p95 2476ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 54.7ms / activate 0.3ms |
| Runtime profile        | p50 2164ms / command p95 2209ms / max RSS 448.1MB / 3 samples/command                                           |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95   |
| -------------------------- | ------ | ----- |
| Import (`full`)            | 54.7ms | 55ms  |
