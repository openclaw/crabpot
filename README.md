...
- **Last dashboard update:** Jun 25, 2026, 08:23 UTC
...
- **GitHub report run:** [28156357009](https://github.com/openclaw/crabpot/actions/runs/28156357009)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2474ms / p95 2660ms / plugin delta RSS 0MB / plugin delta CPU 378ms / OpenClaw import 112ms / activate 0.5ms |
| Runtime profile        | p50 2533ms / command p95 2566ms / max RSS 343.9MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50   | p95     |
| -------------------------- | ----- | ------- |
| Import (`full`)            | 112ms | 112.2ms |
