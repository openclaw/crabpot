...
- **Last dashboard update:** Jun 11, 2026, 09:09 UTC
...
- **GitHub report run:** [27336228199](https://github.com/openclaw/crabpot/actions/runs/27336228199)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2036ms / p95 2074ms / plugin delta RSS 12.4MB / plugin delta CPU 0ms / OpenClaw import 101.9ms / activate 0.3ms |
| Runtime profile        | p50 1928ms / command p95 1996ms / max RSS 332.2MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 101.9ms | 101.9ms |
