...
- **Last dashboard update:** Jul 18, 2026, 19:44 UTC
...
- **GitHub report run:** [29657840313](https://github.com/openclaw/crabpot/actions/runs/29657840313)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 503 ready / 9 blocked / 512 total                                     |
...
| Import loop            | p50 65ms / p95 65ms / plugin delta RSS 0.6MB / plugin delta CPU 11ms  |
| Runtime profile        | p50 5092ms / command p95 5223ms / max RSS 458.5MB / 3 samples/command |
