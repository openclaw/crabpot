...
- **Last dashboard update:** May 22, 2026, 22:07 UTC
...
- **GitHub report run:** [26313972026](https://github.com/openclaw/crabpot/actions/runs/26313972026)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1560ms / p95 1568ms / plugin delta RSS 0MB / plugin delta CPU 45ms / OpenClaw import 80.1ms / activate 0.3ms |
| Runtime profile        | p50 2377ms / command p95 2442ms / max RSS 478MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 80.1ms | 85.4ms |
