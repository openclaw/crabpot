...
- **Last dashboard update:** May 16, 2026, 14:40 UTC
...
- **GitHub report run:** [25964470920](https://github.com/openclaw/crabpot/actions/runs/25964470920)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1132ms / p95 1185ms / plugin delta RSS 0MB / plugin delta CPU 69ms / OpenClaw import 78.4ms / activate 0.3ms |
| Runtime profile        | p50 1866ms / command p95 1911ms / max RSS 458.6MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 78.4ms | 79.4ms |
