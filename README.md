...
- **Last dashboard update:** Jun 30, 2026, 09:09 UTC
<!-- crabpot-tracks:start -->
- **Source:** `npm-latest`
- **OpenClaw version:** `2026.6.10`
- **OpenClaw SHA:** `aa69b12d0086`
...
- **GitHub report run:** [28433193673](https://github.com/openclaw/crabpot/actions/runs/28433193673)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 470 ready / 9 blocked / 479 total                                                                                |
| Cold import            | 7 ready / 101 blocked / 108 entrypoints                                                                          |
| Workspace plan         | 108 entrypoints / 68 installs / 14 builds                                                                        |
| Platform risks         | 24 Windows / 24 container                                                                                        |
| Jiti loader candidates | 22                                                                                                               |
| Import loop            | p50 2332ms / p95 2376ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 113.9ms / activate 0.3ms |
| Runtime profile        | p50 2615ms / command p95 2675ms / max RSS 342.7MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 113.9ms | 114.7ms |
| Activate (`full:register`) | 0.3ms   | 5.4ms   |
