...
- **Last dashboard update:** Sep 10, 2026, 07:55 UTC
...
- **GitHub report run:** [34450456136](https://github.com/openclaw/crabpot/actions/runs/34450456136)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2788ms / p95 2794ms / plugin delta RSS 0MB / plugin delta CPU 8ms / OpenClaw import 112.5ms / activate 0.4ms |
| Runtime profile        | p50 6218ms / command p95 6574ms / max RSS 222.3MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 112.5ms | 121.9ms |
