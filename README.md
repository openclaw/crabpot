...
- **Last dashboard update:** Jun 06, 2026, 09:25 UTC
...
- **GitHub report run:** [27058421669](https://github.com/openclaw/crabpot/actions/runs/27058421669)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2374ms / p95 2393ms / plugin delta RSS 1.4MB / plugin delta CPU 0ms / OpenClaw import 112.6ms / activate 0.4ms |
| Runtime profile        | p50 1858ms / command p95 1907ms / max RSS 324.6MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 112.6ms | 115.6ms |
