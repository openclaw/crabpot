...
- **Last dashboard update:** May 31, 2026, 07:01 UTC
...
- **GitHub report run:** [26705814836](https://github.com/openclaw/crabpot/actions/runs/26705814836)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1676ms / p95 1681ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 104.3ms / activate 0.3ms |
| Runtime profile        | p50 1593ms / command p95 1646ms / max RSS 315MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 104.3ms | 106.6ms |
