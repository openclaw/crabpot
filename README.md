...
- **Last dashboard update:** Jul 13, 2026, 19:03 UTC
...
- **GitHub report run:** [29275890398](https://github.com/openclaw/crabpot/actions/runs/29275890398)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2284ms / p95 2325ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 119.2ms / activate 0.3ms |
| Runtime profile        | p50 6527ms / command p95 6667ms / max RSS 443.2MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 119.2ms | 120.2ms |
