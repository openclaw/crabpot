...
- **Last dashboard update:** Sep 22, 2026, 21:14 UTC
...
- **GitHub report run:** [35782096207](https://github.com/openclaw/crabpot/actions/runs/35782096207)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 3146ms / p95 4082ms / plugin delta RSS 0MB / plugin delta CPU 1453ms / OpenClaw import 67.5ms / activate 0.6ms |
...
| Phase                      | p50    | p95   |
| -------------------------- | ------ | ----- |
| Import (`full`)            | 67.5ms | 70ms  |
| Activate (`full:register`) | 0.6ms  | 0.6ms |
