...
- **Last dashboard update:** Jun 25, 2026, 09:09 UTC
...
- **GitHub report run:** [28159362107](https://github.com/openclaw/crabpot/actions/runs/28159362107)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2443ms / p95 2494ms / plugin delta RSS 9.6MB / plugin delta CPU 18ms / OpenClaw import 121.3ms / activate 0.4ms |
| Runtime profile        | p50 2557ms / command p95 2657ms / max RSS 343.9MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 121.3ms | 122.2ms |
