...
- **Last dashboard update:** Sep 23, 2026, 05:45 UTC
...
- **GitHub report run:** [35821826686](https://github.com/openclaw/crabpot/actions/runs/35821826686)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2995ms / p95 3996ms / plugin delta RSS 0MB / plugin delta CPU 1340ms / OpenClaw import 60.8ms / activate 0.6ms |
...
| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 60.8ms | 64.2ms |
| Activate (`full:register`) | 0.6ms  | 0.7ms  |
