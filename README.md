...
- **Last dashboard update:** Jul 02, 2026, 09:08 UTC
<!-- crabpot-tracks:start -->
- **Source:** `npm-latest`
- **OpenClaw version:** `2026.6.11`
- **OpenClaw SHA:** `e085fa1a3ffd`
...
- **GitHub report run:** [28578549785](https://github.com/openclaw/crabpot/actions/runs/28578549785)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 474 ready / 9 blocked / 483 total                                                                                    |
| Cold import            | 7 ready / 101 blocked / 108 entrypoints                                                                              |
| Workspace plan         | 108 entrypoints / 68 installs / 15 builds                                                                            |
| Platform risks         | 25 Windows / 25 container                                                                                            |
| Jiti loader candidates | 20                                                                                                                   |
| Import loop            | p50 2466ms / p95 2507ms / plugin delta RSS 8.1MB / plugin delta CPU 234ms / OpenClaw import 115.9ms / activate 0.3ms |
| Runtime profile        | p50 2537ms / command p95 2602ms / max RSS 346.1MB / 3 samples/command                                                |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95   |
| -------------------------- | ------- | ----- |
| Import (`full`)            | 115.9ms | 117ms |
