...
- **Last dashboard update:** May 14, 2026, 04:57 UTC
...
- **GitHub report run:** [25842450654](https://github.com/openclaw/crabpot/actions/runs/25842450654)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2342ms / p95 2430ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 80.4ms / activate 0.3ms |
| Runtime profile        | p50 2286ms / command p95 2384ms / max RSS 468.5MB / 3 samples/command                                           |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95   |
| -------------------------- | ------ | ----- |
| Import (`full`)            | 80.4ms | 88ms  |
