...
- **Last dashboard update:** May 27, 2026, 11:27 UTC
...
- **GitHub report run:** [26508216807](https://github.com/openclaw/crabpot/actions/runs/26508216807)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1532ms / p95 1539ms / plugin delta RSS 16.9MB / plugin delta CPU 56ms / OpenClaw import 107.9ms / activate 0.4ms |
| Runtime profile        | p50 2394ms / command p95 2442ms / max RSS 482MB / 3 samples/command                                                  |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 107.9ms | 109.5ms |
