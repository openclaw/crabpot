...
- **Last dashboard update:** May 27, 2026, 08:37 UTC
...
- **GitHub report run:** [26499914839](https://github.com/openclaw/crabpot/actions/runs/26499914839)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1601ms / p95 1616ms / plugin delta RSS 0.8MB / plugin delta CPU 0ms / OpenClaw import 112.5ms / activate 0.4ms |
| Runtime profile        | p50 2422ms / command p95 2527ms / max RSS 485.4MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 112.5ms | 114.8ms |
