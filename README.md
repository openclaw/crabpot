...
- **Last dashboard update:** Jul 08, 2026, 09:08 UTC
...
- **GitHub report run:** [28931051305](https://github.com/openclaw/crabpot/actions/runs/28931051305)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 497 ready / 9 blocked / 506 total                                                                                   |
...
| Import loop            | p50 2583ms / p95 2626ms / plugin delta RSS 14.5MB / plugin delta CPU 156ms / OpenClaw import 126ms / activate 0.4ms |
| Runtime profile        | p50 6663ms / command p95 6722ms / max RSS 421.6MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50   | p95     |
| -------------------------- | ----- | ------- |
| Import (`full`)            | 126ms | 127.2ms |
