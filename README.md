...
- **Last dashboard update:** Aug 04, 2026, 09:26 UTC
...
- **GitHub report run:** [30895060739](https://github.com/openclaw/crabpot/actions/runs/30895060739)
<!-- crabpot-tracks:end -->
...
| P1 issues              | [🟠 P1 122](reports/crabpot-issues.md#triage-summary)                                                              |
...
| Synthetic probes       | 517 ready / 9 blocked / 526 total                                                                                  |
| Cold import            | 8 ready / 113 blocked / 121 entrypoints                                                                            |
| Workspace plan         | 121 entrypoints / 80 installs / 15 builds                                                                          |
| Platform risks         | 17 Windows / 17 container                                                                                          |
| Jiti loader candidates | 20                                                                                                                 |
| Import loop            | p50 2321ms / p95 2386ms / plugin delta RSS 0MB / plugin delta CPU 177ms / OpenClaw import 106.9ms / activate 0.3ms |
| Runtime profile        | p50 9565ms / command p95 9613ms / max RSS 764.6MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 106.9ms | 107.4ms |
...
| 🟠 P1    | compat-gap        | clawmetry   | missing-compat-record    | core-compat-adapter | [clawmetry: compat-dependent behavior lacks registry coverage](reports/crabpot-issues.md#compat-gaps)                          |
| 🟠 P1    | compat-gap        | clawrouter  | missing-compat-record    | core-compat-adapter | [clawrouter: compat-dependent behavior lacks registry coverage](reports/crabpot-issues.md#compat-gaps)                         |
