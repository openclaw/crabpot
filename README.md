...
- **Last dashboard update:** Jul 06, 2026, 15:59 UTC
...
- **GitHub report run:** [28803988778](https://github.com/openclaw/crabpot/actions/runs/28803988778)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 496 ready / 9 blocked / 505 total                                                                                  |
...
| Import loop            | p50 2432ms / p95 2469ms / plugin delta RSS 2.2MB / plugin delta CPU 0ms / OpenClaw import 115.3ms / activate 0.4ms |
| Runtime profile        | p50 6245ms / command p95 6374ms / max RSS 420.5MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 115.3ms | 115.8ms |
