...
- **Last dashboard update:** Jun 05, 2026, 20:42 UTC
<!-- crabpot-tracks:start -->
- **Source:** `npm-latest`
- **OpenClaw version:** `2026.6.1`
- **OpenClaw SHA:** `2e08f0f4221f`
...
- **GitHub report run:** [27038526886](https://github.com/openclaw/crabpot/actions/runs/27038526886)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 447 ready / 9 blocked / 456 total                                                                                     |
| Cold import            | 7 ready / 100 blocked / 107 entrypoints                                                                               |
| Workspace plan         | 107 entrypoints / 42 installs / 13 builds                                                                             |
| Platform risks         | 16 Windows / 16 container                                                                                             |
| Jiti loader candidates | 22                                                                                                                    |
| Import loop            | p50 2418ms / p95 2450ms / plugin delta RSS 16.7MB / plugin delta CPU 130ms / OpenClaw import 111.7ms / activate 0.4ms |
| Runtime profile        | p50 1853ms / command p95 1912ms / max RSS 326.5MB / 3 samples/command                                                 |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 111.7ms | 114.6ms |
