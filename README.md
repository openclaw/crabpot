...
- **Last dashboard update:** Jul 30, 2026, 10:08 UTC
...
- **GitHub report run:** [30532811434](https://github.com/openclaw/crabpot/actions/runs/30532811434)
<!-- crabpot-tracks:end -->
...
| P1 issues              | [🟠 P1 131](reports/crabpot-issues.md#triage-summary)                                                                |
...
| Synthetic probes       | 517 ready / 10 blocked / 527 total                                                                                   |
...
| Import loop            | p50 2898ms / p95 2904ms / plugin delta RSS 6.1MB / plugin delta CPU 142ms / OpenClaw import 121.1ms / activate 0.3ms |
| Runtime profile        | p50 6789ms / command p95 6891ms / max RSS 540MB / 3 samples/command                                                  |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 121.1ms | 124.8ms |
