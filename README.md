...
- **Last dashboard update:** Sep 25, 2026, 10:16 UTC
...
- **GitHub report run:** [36121970179](https://github.com/openclaw/crabpot/actions/runs/36121970179)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2557ms / p95 2560ms / plugin delta RSS 3.8MB / plugin delta CPU 0ms / OpenClaw import 72ms / activate 0.8ms |
| Runtime profile        | p50 7671ms / command p95 7883ms / max RSS 757.7MB / 3 samples/command                                           |

### OpenClaw Lifecycle Probe

| Phase                      | p50   | p95   |
| -------------------------- | ----- | ----- |
| Import (`full`)            | 72ms  | 75ms  |
| Activate (`full:register`) | 0.8ms | 0.8ms |
