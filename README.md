...
- **Last dashboard update:** May 14, 2026, 02:09 UTC
...
- **GitHub report run:** [25837382912](https://github.com/openclaw/crabpot/actions/runs/25837382912)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2391ms / p95 2417ms / plugin delta RSS 2MB / plugin delta CPU 68ms / OpenClaw import 85.1ms / activate 0.3ms |
| Runtime profile        | p50 2280ms / command p95 2338ms / max RSS 465.9MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 85.1ms | 95.5ms |
