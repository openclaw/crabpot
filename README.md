...
- **Last dashboard update:** May 20, 2026, 14:46 UTC
<!-- crabpot-tracks:start -->
- **Source:** `npm-latest`
- **OpenClaw version:** `2026.5.18`
- **OpenClaw SHA:** `50a2481652b6`
...
- **GitHub report run:** [26170108678](https://github.com/openclaw/crabpot/actions/runs/26170108678)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1416ms / p95 1444ms / plugin delta RSS 3.4MB / plugin delta CPU 36ms / OpenClaw import 80.6ms / activate 0.3ms |
| Runtime profile        | p50 2328ms / command p95 2378ms / max RSS 472.4MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95     |
| -------------------------- | ------ | ------- |
| Import (`full`)            | 80.6ms | 100.3ms |
