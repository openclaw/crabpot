...
- **Last dashboard update:** Sep 22, 2026, 09:23 UTC
...
- **GitHub report run:** [35708732080](https://github.com/openclaw/crabpot/actions/runs/35708732080)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 3181ms / p95 3277ms / plugin delta RSS 2.8MB / plugin delta CPU 93ms / OpenClaw import 65.9ms / activate 0.5ms |
| Runtime profile        | p50 12201ms / command p95 12532ms / max RSS 758.9MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 65.9ms | 69.7ms |
