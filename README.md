...
- **Last dashboard update:** Jul 06, 2026, 09:51 UTC
...
- **GitHub report run:** [28782891920](https://github.com/openclaw/crabpot/actions/runs/28782891920)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2460ms / p95 2482ms / plugin delta RSS 0MB / plugin delta CPU 5ms / OpenClaw import 120.1ms / activate 0.3ms |
| Runtime profile        | p50 2580ms / command p95 2679ms / max RSS 345.2MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 120.1ms | 121.4ms |
