...
- **Last dashboard update:** Sep 22, 2026, 11:51 UTC
...
- **GitHub report run:** [35723104388](https://github.com/openclaw/crabpot/actions/runs/35723104388)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 3094ms / p95 3102ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 66ms / activate 0.5ms |
| Runtime profile        | p50 11949ms / command p95 12271ms / max RSS 759.6MB / 3 samples/command                                       |

### OpenClaw Lifecycle Probe

| Phase                      | p50   | p95    |
| -------------------------- | ----- | ------ |
| Import (`full`)            | 66ms  | 68.4ms |
| Activate (`full:register`) | 0.5ms | 0.8ms  |
