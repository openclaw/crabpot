...
- **Last dashboard update:** May 07, 2026, 09:27 UTC
...
- **GitHub report run:** [25487500006](https://github.com/openclaw/crabpot/actions/runs/25487500006)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2422ms / p95 2428ms / plugin delta RSS 6.4MB / plugin delta CPU 0ms / OpenClaw import 75.5ms / activate 0.4ms |
| Runtime profile        | p50 2305ms / command p95 2385ms / max RSS 457.4MB / 3 samples/command                                             |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95   |
| -------------------------- | ------ | ----- |
| Import (`full`)            | 75.5ms | 94ms  |
