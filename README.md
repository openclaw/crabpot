...
- **Last dashboard update:** Jun 26, 2026, 09:14 UTC
...
- **GitHub report run:** [28228495789](https://github.com/openclaw/crabpot/actions/runs/28228495789)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 472 ready / 9 blocked / 481 total                                                                                  |
...
| Import loop            | p50 2247ms / p95 2300ms / plugin delta RSS 6.9MB / plugin delta CPU 0ms / OpenClaw import 112.1ms / activate 0.3ms |
| Runtime profile        | p50 2554ms / command p95 2605ms / max RSS 342.7MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 112.1ms | 116.3ms |
