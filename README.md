...
- **Last dashboard update:** Sep 08, 2026, 13:49 UTC
...
- **GitHub report run:** [34232522088](https://github.com/openclaw/crabpot/actions/runs/34232522088)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2646ms / p95 2690ms / plugin delta RSS 1.5MB / plugin delta CPU 83ms / OpenClaw import 107ms / activate 0.4ms |
| Runtime profile        | p50 5674ms / command p95 5739ms / max RSS 204.7MB / 3 samples/command                                             |

### OpenClaw Lifecycle Probe

| Phase                      | p50   | p95     |
| -------------------------- | ----- | ------- |
| Import (`full`)            | 107ms | 109.2ms |
