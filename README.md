...
- **Last dashboard update:** Jun 11, 2026, 06:41 UTC
...
- **GitHub report run:** [27328433096](https://github.com/openclaw/crabpot/actions/runs/27328433096)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2212ms / p95 2284ms / plugin delta RSS 6MB / plugin delta CPU 105ms / OpenClaw import 112.2ms / activate 0.3ms |
| Runtime profile        | p50 2042ms / command p95 2103ms / max RSS 333.8MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 112.2ms | 115.1ms |
