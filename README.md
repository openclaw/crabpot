...
- **Last dashboard update:** Jul 06, 2026, 09:24 UTC
...
- **GitHub report run:** [28781000727](https://github.com/openclaw/crabpot/actions/runs/28781000727)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2513ms / p95 2519ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 118.3ms / activate 0.4ms |
| Runtime profile        | p50 2613ms / command p95 2695ms / max RSS 345.3MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 118.3ms | 125.6ms |
