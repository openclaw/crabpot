...
- **Last dashboard update:** Jul 30, 2026, 09:59 UTC
...
- **GitHub report run:** [30532789281](https://github.com/openclaw/crabpot/actions/runs/30532789281)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2892ms / p95 2925ms / plugin delta RSS 4.8MB / plugin delta CPU 52ms / OpenClaw import 124.3ms / activate 0.3ms |
| Runtime profile        | p50 6839ms / command p95 6877ms / max RSS 543.4MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 124.3ms | 135.1ms |
