...
- **Last dashboard update:** Jul 08, 2026, 09:18 UTC
...
- **GitHub report run:** [28931056590](https://github.com/openclaw/crabpot/actions/runs/28931056590)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2446ms / p95 2458ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 116.5ms / activate 0.4ms |
| Runtime profile        | p50 6294ms / command p95 6396ms / max RSS 519MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 116.5ms | 119.3ms |
