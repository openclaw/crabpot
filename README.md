...
- **Last dashboard update:** Jun 23, 2026, 09:09 UTC
...
- **GitHub report run:** [28015208270](https://github.com/openclaw/crabpot/actions/runs/28015208270)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2308ms / p95 2322ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 114.3ms / activate 0.3ms |
| Runtime profile        | p50 2561ms / command p95 2590ms / max RSS 342.4MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 114.3ms | 114.8ms |
