...
- **Last dashboard update:** Jul 01, 2026, 09:15 UTC
...
- **GitHub report run:** [28506789309](https://github.com/openclaw/crabpot/actions/runs/28506789309)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 473 ready / 9 blocked / 482 total                                                                                   |
...
| Import loop            | p50 2220ms / p95 2249ms / plugin delta RSS 10.4MB / plugin delta CPU 0ms / OpenClaw import 111.5ms / activate 0.4ms |
| Runtime profile        | p50 2553ms / command p95 2627ms / max RSS 343.4MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95   |
| -------------------------- | ------- | ----- |
| Import (`full`)            | 111.5ms | 115ms |
