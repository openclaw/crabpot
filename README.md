...
- **Last dashboard update:** May 27, 2026, 11:23 UTC
...
- **GitHub report run:** [26507905143](https://github.com/openclaw/crabpot/actions/runs/26507905143)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1489ms / p95 1489ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 107.9ms / activate 0.3ms |
| Runtime profile        | p50 2467ms / command p95 2551ms / max RSS 486.1MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 107.9ms | 111.3ms |
