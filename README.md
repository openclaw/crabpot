...
- **Last dashboard update:** Jul 28, 2026, 08:52 UTC
...
- **GitHub report run:** [30343066346](https://github.com/openclaw/crabpot/actions/runs/30343066346)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1802ms / p95 1823ms / plugin delta RSS 31.1MB / plugin delta CPU 0ms / OpenClaw import 85.2ms / activate 0.2ms |
| Runtime profile        | p50 5158ms / command p95 5407ms / max RSS 460.2MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 85.2ms | 86.9ms |
