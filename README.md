...
- **Last dashboard update:** May 31, 2026, 07:07 UTC
...
- **GitHub report run:** [26706097044](https://github.com/openclaw/crabpot/actions/runs/26706097044)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1965ms / p95 1969ms / plugin delta RSS 7.7MB / plugin delta CPU 0ms / OpenClaw import 118.1ms / activate 0.3ms |
| Runtime profile        | p50 1780ms / command p95 1850ms / max RSS 315.4MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95   |
| -------------------------- | ------- | ----- |
| Import (`full`)            | 118.1ms | 124ms |
