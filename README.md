...
- **Last dashboard update:** Jun 11, 2026, 06:58 UTC
...
- **GitHub report run:** [27329123771](https://github.com/openclaw/crabpot/actions/runs/27329123771)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2397ms / p95 2460ms / plugin delta RSS 2.4MB / plugin delta CPU 0ms / OpenClaw import 116.3ms / activate 0.4ms |
| Runtime profile        | p50 2096ms / command p95 2160ms / max RSS 329.4MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 116.3ms | 117.2ms |
