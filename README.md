...
- **Last dashboard update:** Jul 27, 2026, 10:31 UTC
...
- **GitHub report run:** [30257124667](https://github.com/openclaw/crabpot/actions/runs/30257124667)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1987ms / p95 1989ms / plugin delta RSS 0MB / plugin delta CPU 27ms / OpenClaw import 91ms / activate 0.2ms |
| Runtime profile        | p50 5798ms / command p95 5904ms / max RSS 525.2MB / 3 samples/command                                          |

### OpenClaw Lifecycle Probe

| Phase                      | p50   | p95    |
| -------------------------- | ----- | ------ |
| Import (`full`)            | 91ms  | 91.1ms |
