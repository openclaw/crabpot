...
- **Last dashboard update:** Jun 11, 2026, 06:18 UTC
<!-- crabpot-tracks:start -->
- **Source:** `npm-latest`
- **OpenClaw version:** `2026.6.5`
- **OpenClaw SHA:** `5181e4f7c82b`
...
- **GitHub report run:** [27327460976](https://github.com/openclaw/crabpot/actions/runs/27327460976)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2576ms / p95 2613ms / plugin delta RSS 16.7MB / plugin delta CPU 174ms / OpenClaw import 120.3ms / activate 0.4ms |
| Runtime profile        | p50 2130ms / command p95 2188ms / max RSS 334.5MB / 3 samples/command                                                 |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 120.3ms | 122.9ms |
