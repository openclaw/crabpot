...
- **Last dashboard update:** Jul 15, 2026, 09:18 UTC
<!-- crabpot-tracks:start -->
- **Source:** `npm-latest`
- **OpenClaw version:** `2026.7.1`
- **OpenClaw SHA:** `2d2ddc43d0dc`
...
- **GitHub report run:** [29403772248](https://github.com/openclaw/crabpot/actions/runs/29403772248)
<!-- crabpot-tracks:end -->
...
| P1 issues              | [🟠 P1 17](reports/crabpot-issues.md#triage-summary)                                                              |
...
| Synthetic probes       | 502 ready / 9 blocked / 511 total                                                                                 |
| Cold import            | 7 ready / 101 blocked / 108 entrypoints                                                                           |
| Workspace plan         | 108 entrypoints / 68 installs / 15 builds                                                                         |
| Platform risks         | 17 Windows / 17 container                                                                                         |
| Jiti loader candidates | 20                                                                                                                |
| Import loop            | p50 2571ms / p95 2592ms / plugin delta RSS 0MB / plugin delta CPU 79ms / OpenClaw import 124.6ms / activate 0.4ms |
| Runtime profile        | p50 6405ms / command p95 6475ms / max RSS 441.4MB / 3 samples/command                                             |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 124.6ms | 128.2ms |
...
| 🟠 P1    | compat-gap        | memory-lancedb    | sdk-export-missing        | core-compat-adapter | [memory-lancedb: plugin SDK import aliases are missing from target package exports](reports/crabpot-issues.md#compat-gaps)     |
<!-- crabpot-summary:end -->
## What this tests
