...
- **Last dashboard update:** May 31, 2026, 07:16 UTC
...
- **GitHub report run:** [26706244397](https://github.com/openclaw/crabpot/actions/runs/26706244397)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2039ms / p95 2053ms / plugin delta RSS 0MB / plugin delta CPU 61ms / OpenClaw import 112ms / activate 0.4ms |
| Runtime profile        | p50 1808ms / command p95 1876ms / max RSS 322.5MB / 3 samples/command                                           |

### OpenClaw Lifecycle Probe

| Phase                      | p50   | p95   |
| -------------------------- | ----- | ----- |
| Import (`full`)            | 112ms | 118ms |
