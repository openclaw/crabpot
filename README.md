...
- **Last dashboard update:** May 27, 2026, 08:11 UTC
...
- **GitHub report run:** [26498746391](https://github.com/openclaw/crabpot/actions/runs/26498746391)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1539ms / p95 1546ms / plugin delta RSS 12.9MB / plugin delta CPU 0ms / OpenClaw import 106.8ms / activate 0.4ms |
| Runtime profile        | p50 2390ms / command p95 2488ms / max RSS 486.9MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95   |
| -------------------------- | ------- | ----- |
| Import (`full`)            | 106.8ms | 111ms |
