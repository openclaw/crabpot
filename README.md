...
- **Last dashboard update:** May 25, 2026, 14:23 UTC
...
- **GitHub report run:** [26405074186](https://github.com/openclaw/crabpot/actions/runs/26405074186)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1550ms / p95 1578ms / plugin delta RSS 0MB / plugin delta CPU 46ms / OpenClaw import 113.4ms / activate 0.3ms |
| Runtime profile        | p50 2392ms / command p95 2436ms / max RSS 476.4MB / 3 samples/command                                             |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 113.4ms | 119.1ms |
