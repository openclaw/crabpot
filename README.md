...
- **Last dashboard update:** May 03, 2026, 07:26 UTC
...
- **GitHub report run:** [25272881173](https://github.com/openclaw/crabpot/actions/runs/25272881173)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2269ms / p95 2301ms / plugin delta RSS 17.6MB / plugin delta CPU 0ms / OpenClaw import 56ms / activate 0.3ms |
| Runtime profile        | p50 2385ms / command p95 2439ms / max RSS 452.1MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50   | p95   |
| -------------------------- | ----- | ----- |
| Import (`full`)            | 56ms  | 57ms  |
