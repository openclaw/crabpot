...
- **Last dashboard update:** Aug 03, 2026, 09:47 UTC
...
- **GitHub report run:** [30802755998](https://github.com/openclaw/crabpot/actions/runs/30802755998)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2158ms / p95 2241ms / plugin delta RSS 9.1MB / plugin delta CPU 168ms / OpenClaw import 94.1ms / activate 0.3ms |
| Runtime profile        | p50 5266ms / command p95 5387ms / max RSS 546.3MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 94.1ms | 97.8ms |
