...
- **Last dashboard update:** Jun 17, 2026, 03:55 UTC
...
- **GitHub report run:** [27664327767](https://github.com/openclaw/crabpot/actions/runs/27664327767)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2245ms / p95 2296ms / plugin delta RSS 0MB / plugin delta CPU 179ms / OpenClaw import 112.5ms / activate 0.3ms |
| Runtime profile        | p50 2533ms / command p95 2587ms / max RSS 342MB / 3 samples/command                                                |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 112.5ms | 113.9ms |
