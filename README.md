...
- **Last dashboard update:** Sep 22, 2026, 10:42 UTC
...
- **GitHub report run:** [35714568851](https://github.com/openclaw/crabpot/actions/runs/35714568851)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2612ms / p95 2624ms / plugin delta RSS 2MB / plugin delta CPU 22ms / OpenClaw import 54.1ms / activate 0.4ms |
