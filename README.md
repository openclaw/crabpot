...
- **Last dashboard update:** May 27, 2026, 06:53 UTC
...
- **GitHub report run:** [26495298730](https://github.com/openclaw/crabpot/actions/runs/26495298730)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1597ms / p95 1610ms / plugin delta RSS 0MB / plugin delta CPU 29ms / OpenClaw import 110.5ms / activate 0.4ms |
| Runtime profile        | p50 2483ms / command p95 2558ms / max RSS 484.6MB / 3 samples/command                                             |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 110.5ms | 115.5ms |
