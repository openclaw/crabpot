...
- **Last dashboard update:** Jun 11, 2026, 09:20 UTC
...
- **GitHub report run:** [27336731535](https://github.com/openclaw/crabpot/actions/runs/27336731535)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2245ms / p95 2276ms / plugin delta RSS 15.6MB / plugin delta CPU 0ms / OpenClaw import 113.6ms / activate 0.4ms |
| Runtime profile        | p50 2086ms / command p95 2175ms / max RSS 325.6MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 113.6ms | 124.2ms |
