...
- **Last dashboard update:** Jun 02, 2026, 03:55 UTC
...
- **GitHub report run:** [26797335723](https://github.com/openclaw/crabpot/actions/runs/26797335723)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1034ms / p95 1077ms / plugin delta RSS 1.8MB / plugin delta CPU 112ms / OpenClaw import 74.7ms / activate 0.2ms |
| Runtime profile        | p50 1075ms / command p95 1152ms / max RSS 330.6MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 74.7ms | 75.9ms |
