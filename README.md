...
- **Last dashboard update:** Sep 21, 2026, 09:35 UTC
...
- **GitHub report run:** [35583978972](https://github.com/openclaw/crabpot/actions/runs/35583978972)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2772ms / p95 2773ms / plugin delta RSS 0MB / plugin delta CPU 15ms / OpenClaw import 59.3ms / activate 0.4ms |
| Runtime profile        | p50 11043ms / command p95 11346ms / max RSS 755.4MB / 3 samples/command                                          |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 59.3ms | 62.7ms |
