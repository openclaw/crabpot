...
- **Last dashboard update:** May 27, 2026, 11:18 UTC
...
- **GitHub report run:** [26507893334](https://github.com/openclaw/crabpot/actions/runs/26507893334)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1151ms / p95 1165ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 86.5ms / activate 0.3ms |
| Runtime profile        | p50 1915ms / command p95 1930ms / max RSS 482.2MB / 3 samples/command                                           |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95   |
| -------------------------- | ------ | ----- |
| Import (`full`)            | 86.5ms | 88ms  |
