...
- **Last dashboard update:** May 27, 2026, 09:38 UTC
...
- **GitHub report run:** [26502877346](https://github.com/openclaw/crabpot/actions/runs/26502877346)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1511ms / p95 1517ms / plugin delta RSS 9.7MB / plugin delta CPU 79ms / OpenClaw import 112.3ms / activate 0.3ms |
| Runtime profile        | p50 2465ms / command p95 2592ms / max RSS 484.8MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 112.3ms | 113.6ms |
