...
- **Last dashboard update:** Sep 20, 2026, 20:12 UTC
...
- **GitHub report run:** [35533126732](https://github.com/openclaw/crabpot/actions/runs/35533126732)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1913ms / p95 1970ms / plugin delta RSS 3.8MB / plugin delta CPU 0ms / OpenClaw import 42.6ms / activate 0.3ms |
| Runtime profile        | p50 8165ms / command p95 8538ms / max RSS 759.5MB / 3 samples/command                                             |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 42.6ms | 43.6ms |
