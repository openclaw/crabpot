...
- **Last dashboard update:** May 22, 2026, 09:30 UTC
...
- **GitHub report run:** [26279871805](https://github.com/openclaw/crabpot/actions/runs/26279871805)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1153ms / p95 1162ms / plugin delta RSS 0MB / plugin delta CPU 0ms / OpenClaw import 65.4ms / activate 0.3ms |
| Runtime profile        | p50 1880ms / command p95 1989ms / max RSS 483.7MB / 3 samples/command                                           |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 65.4ms | 67.6ms |
