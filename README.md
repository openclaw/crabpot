...
- **Last dashboard update:** May 06, 2026, 09:57 UTC
<!-- crabpot-tracks:start -->
- **Source:** `npm-latest`
- **OpenClaw version:** `2026.5.5`
- **OpenClaw SHA:** `b1abf9d8ae44`
...
- **GitHub report run:** [25428165557](https://github.com/openclaw/crabpot/actions/runs/25428165557)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 424 ready / 0 blocked / 424 total                                                                                  |
...
| Import loop            | p50 2290ms / p95 2296ms / plugin delta RSS 10.3MB / plugin delta CPU 0ms / OpenClaw import 89.9ms / activate 0.3ms |
| Runtime profile        | p50 2254ms / command p95 2334ms / max RSS 447.1MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 89.9ms | 98.1ms |
