...
- **Last dashboard update:** Sep 22, 2026, 09:09 UTC
...
- **GitHub report run:** [35708628117](https://github.com/openclaw/crabpot/actions/runs/35708628117)
<!-- crabpot-tracks:end -->
...
| Synthetic probes       | 505 ready / 10 blocked / 515 total                                                                                  |
...
| Import loop            | p50 2254ms / p95 2264ms / plugin delta RSS 28.4MB / plugin delta CPU 31ms / OpenClaw import 44.7ms / activate 0.4ms |
| Runtime profile        | p50 8923ms / command p95 9179ms / max RSS 754.6MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 44.7ms | 46.6ms |
