...
- **Last dashboard update:** May 29, 2026, 02:32 UTC
...
- **GitHub report run:** [26614118868](https://github.com/openclaw/crabpot/actions/runs/26614118868)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2052ms / p95 2062ms / plugin delta RSS 11.3MB / plugin delta CPU 15ms / OpenClaw import 106.4ms / activate 0.4ms |
| Runtime profile        | p50 2487ms / command p95 2579ms / max RSS 482.7MB / 3 samples/command                                                |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 106.4ms | 117.9ms |
