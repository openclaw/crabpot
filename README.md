...
- **Last dashboard update:** May 07, 2026, 09:37 UTC
...
- **GitHub report run:** [25487852476](https://github.com/openclaw/crabpot/actions/runs/25487852476)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 2033ms / p95 2110ms / plugin delta RSS 10.1MB / plugin delta CPU 59ms / OpenClaw import 85.9ms / activate 0.5ms |
| Runtime profile        | p50 2167ms / command p95 2222ms / max RSS 467.9MB / 3 samples/command                                               |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 85.9ms | 93.5ms |
