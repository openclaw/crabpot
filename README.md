...
- **Last dashboard update:** Sep 22, 2026, 12:09 UTC
...
- **GitHub report run:** [35723141823](https://github.com/openclaw/crabpot/actions/runs/35723141823)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 3032ms / p95 3044ms / plugin delta RSS 3.1MB / plugin delta CPU 44ms / OpenClaw import 60.1ms / activate 0.5ms |
| Runtime profile        | p50 11356ms / command p95 11670ms / max RSS 759.9MB / 3 samples/command                                            |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 60.1ms | 65.7ms |
