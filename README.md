...
- **Last dashboard update:** May 25, 2026, 14:18 UTC
...
- **GitHub report run:** [26405047781](https://github.com/openclaw/crabpot/actions/runs/26405047781)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1516ms / p95 1553ms / plugin delta RSS 3.9MB / plugin delta CPU 0ms / OpenClaw import 105.8ms / activate 0.4ms |
| Runtime profile        | p50 2363ms / command p95 2428ms / max RSS 476.9MB / 3 samples/command                                              |

### OpenClaw Lifecycle Probe

| Phase                      | p50     | p95     |
| -------------------------- | ------- | ------- |
| Import (`full`)            | 105.8ms | 108.7ms |
