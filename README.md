...
- **Last dashboard update:** May 16, 2026, 02:39 UTC
...
- **GitHub report run:** [25950500943](https://github.com/openclaw/crabpot/actions/runs/25950500943)
<!-- crabpot-tracks:end -->
...
| Import loop            | p50 1494ms / p95 1510ms / plugin delta RSS 7.7MB / plugin delta CPU 0ms / OpenClaw import 92.5ms / activate 0.4ms |
| Runtime profile        | p50 2286ms / command p95 2339ms / max RSS 457.1MB / 3 samples/command                                             |

### OpenClaw Lifecycle Probe

| Phase                      | p50    | p95    |
| -------------------------- | ------ | ------ |
| Import (`full`)            | 92.5ms | 95.3ms |
