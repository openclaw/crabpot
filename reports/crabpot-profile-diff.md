...
| ------ | ------------------------------- | ---------------------- | -------- | ------- | ------------------ | ------- | -------------------------------------------------------------- |
| warn   | profile.wall-p95                | p95WallMs              | 1273     | 5673    | 4400               | 345.6%  | p95WallMs regressed 345.6% over baseline                       |
| pass   | profile.peak-rss                | maxPeakRssMb           | 65.1     | 75.5    | 10.400000000000006 | -       | maxPeakRssMb stayed within 50 absolute regression threshold    |
| pass   | profile.node-boot               | nodeBootWallMs         | 917      | 939     | 22                 | -       | nodeBootWallMs stayed within 500 absolute regression threshold |
...
| pass   | registry.sdkExports             | sdkExports             | 307      | 308     | 1                  | -       | registry surface delta is tracked as context                   |
