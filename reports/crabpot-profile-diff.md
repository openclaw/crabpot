...
| ------ | ------------------------------- | ---------------------- | -------- | ------- | ------------------ | ------- | -------------------------------------------------------------- |
| warn   | profile.wall-p95                | p95WallMs              | 1273     | 2440    | 1167               | 91.7%   | p95WallMs regressed 91.7% over baseline                        |
| warn   | profile.peak-rss                | maxPeakRssMb           | 65.1     | 473.3   | 408.20000000000005 | -       | maxPeakRssMb regressed 408.20000000000005 over baseline        |
| pass   | profile.node-boot               | nodeBootWallMs         | 917      | 41      | -876               | -       | nodeBootWallMs stayed within 500 absolute regression threshold |
...
| pass   | registry.sdkExports             | sdkExports             | 307      | 312     | 5                  | -       | registry surface delta is tracked as context                   |
