...
| Import loop                 | p50 3032 ms / p95 3044 ms / plugin delta RSS 3.1 MB / plugin delta CPU 44 ms / OpenClaw import 60.1 ms / activate 0.5 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 11670   | p95WallMs regressed 816.7% over baseline   |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 759.9   | maxPeakRssMb regressed 694.8 over baseline |
