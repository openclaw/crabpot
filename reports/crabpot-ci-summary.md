...
| Import loop                 | p50 3094 ms / p95 3102 ms / plugin delta RSS 0 MB / plugin delta CPU 0 ms / OpenClaw import 66 ms / activate 0.5 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 12271   | p95WallMs regressed 863.9% over baseline   |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 759.6   | maxPeakRssMb regressed 694.5 over baseline |
