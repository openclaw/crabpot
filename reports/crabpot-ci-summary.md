...
| Import loop                 | p50 1553 ms / p95 1568 ms / plugin delta RSS 0 MB / plugin delta CPU 0 ms / OpenClaw import 108.7 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2487    | p95WallMs regressed 95.4% over baseline                 |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 476.3   | maxPeakRssMb regressed 411.20000000000005 over baseline |
