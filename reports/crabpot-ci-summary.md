...
| Import loop                 | p50 1539 ms / p95 1546 ms / plugin delta RSS 12.9 MB / plugin delta CPU 0 ms / OpenClaw import 106.8 ms / activate 0.4 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2488    | p95WallMs regressed 95.4% over baseline                 |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 486.9   | maxPeakRssMb regressed 421.79999999999995 over baseline |
