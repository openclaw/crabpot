...
| Import loop                 | p50 2158 ms / p95 2241 ms / plugin delta RSS 9.1 MB / plugin delta CPU 168 ms / OpenClaw import 94.1 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 5387    | p95WallMs regressed 323.2% over baseline                |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 546.3   | maxPeakRssMb regressed 481.19999999999993 over baseline |
