...
| Import loop                 | p50 2220 ms / p95 2232 ms / plugin delta RSS 35.5 MB / plugin delta CPU 0 ms / OpenClaw import 103.1 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 6625    | p95WallMs regressed 420.4% over baseline                |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 434.3   | maxPeakRssMb regressed 369.20000000000005 over baseline |
