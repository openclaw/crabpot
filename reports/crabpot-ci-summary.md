...
| Import loop                 | p50 2898 ms / p95 2904 ms / plugin delta RSS 6.1 MB / plugin delta CPU 142 ms / OpenClaw import 121.1 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 6891    | p95WallMs regressed 441.3% over baseline   |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 540     | maxPeakRssMb regressed 474.9 over baseline |
