...
| Import loop                 | p50 2457 ms / p95 2487 ms / plugin delta RSS 1.8 MB / plugin delta CPU 133 ms / OpenClaw import 77.2 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2385    | p95WallMs regressed 87.4% over baseline                 |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 465.9   | maxPeakRssMb regressed 400.79999999999995 over baseline |
