...
| Import loop                 | p50 3048 ms / p95 3092 ms / plugin delta RSS 0 MB / plugin delta CPU 142 ms / OpenClaw import 62.8 ms / activate 0.5 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 6473    | p95WallMs regressed 408.5% over baseline   |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 313.5   | maxPeakRssMb regressed 248.4 over baseline |
