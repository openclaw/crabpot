...
| Import loop                 | p50 2486 ms / p95 2602 ms / plugin delta RSS 6.8 MB / plugin delta CPU 122 ms / OpenClaw import 115.9 ms / activate 0.4 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2555    | p95WallMs regressed 100.7% over baseline                |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 341.9   | maxPeakRssMb regressed 276.79999999999995 over baseline |
