...
| Import loop                 | p50 2245 ms / p95 2296 ms / plugin delta RSS 0 MB / plugin delta CPU 179 ms / OpenClaw import 112.5 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2587    | p95WallMs regressed 103.2% over baseline   |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 342     | maxPeakRssMb regressed 276.9 over baseline |
