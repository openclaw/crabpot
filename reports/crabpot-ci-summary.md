...
| Import loop                 | p50 1484 ms / p95 1515 ms / plugin delta RSS 1 MB / plugin delta CPU 59 ms / OpenClaw import 92 ms / activate 0.4 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2303    | p95WallMs regressed 80.9% over baseline    |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 465.7   | maxPeakRssMb regressed 400.6 over baseline |
