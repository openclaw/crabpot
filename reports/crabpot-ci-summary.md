...
| Import loop                 | p50 1157 ms / p95 1172 ms / plugin delta RSS 3.6 MB / plugin delta CPU 104 ms / OpenClaw import 65.8 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 483.5   | maxPeakRssMb regressed 418.4 over baseline |
