...
| Import loop                 | p50 2321 ms / p95 2386 ms / plugin delta RSS 0 MB / plugin delta CPU 177 ms / OpenClaw import 106.9 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 9613    | p95WallMs regressed 655.1% over baseline   |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 764.6   | maxPeakRssMb regressed 699.5 over baseline |
