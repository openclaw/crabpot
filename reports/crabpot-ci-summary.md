...
| Import loop                 | p50 1777 ms / p95 1789 ms / plugin delta RSS 0 MB / plugin delta CPU 0 ms / OpenClaw import 91.4 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2067    | p95WallMs regressed 62.4% over baseline                 |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 342.9   | maxPeakRssMb regressed 277.79999999999995 over baseline |
