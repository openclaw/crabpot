...
| Import loop                 | p50 2230 ms / p95 3571 ms / plugin delta RSS 0 MB / plugin delta CPU 0 ms / OpenClaw import 347.7 ms / activate 0.2 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 7804    | p95WallMs regressed 513% over baseline                  |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 521.8   | maxPeakRssMb regressed 456.69999999999993 over baseline |
