...
| Import loop                 | p50 2391 ms / p95 2417 ms / plugin delta RSS 2 MB / plugin delta CPU 68 ms / OpenClaw import 85.1 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2338    | p95WallMs regressed 83.7% over baseline                 |
