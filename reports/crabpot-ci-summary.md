...
| Import loop                 | p50 3196 ms / p95 3209 ms / plugin delta RSS 0 MB / plugin delta CPU 61 ms / OpenClaw import 129.9 ms / activate 0.4 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 6602    | p95WallMs regressed 418.6% over baseline   |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 463.7   | maxPeakRssMb regressed 398.6 over baseline |
