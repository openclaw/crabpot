...
| Import loop                 | p50 2280 ms / p95 2287 ms / plugin delta RSS 1.4 MB / plugin delta CPU 0 ms / OpenClaw import 47.4 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 9401    | p95WallMs regressed 638.5% over baseline   |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 757.5   | maxPeakRssMb regressed 692.4 over baseline |
