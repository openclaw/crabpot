...
| Import loop                 | p50 2466 ms / p95 2507 ms / plugin delta RSS 8.1 MB / plugin delta CPU 234 ms / OpenClaw import 115.9 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ---------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2602    | p95WallMs regressed 104.4% over baseline |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 346.1   | maxPeakRssMb regressed 281 over baseline |
