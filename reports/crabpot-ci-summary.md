...
| Import loop                 | p50 2422 ms / p95 2423 ms / plugin delta RSS 0.1 MB / plugin delta CPU 0 ms / OpenClaw import 115 ms / activate 0.4 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 1950    | p95WallMs regressed 53.2% over baseline    |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 324.6   | maxPeakRssMb regressed 259.5 over baseline |
