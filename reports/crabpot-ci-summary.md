...
| Import loop                 | p50 2772 ms / p95 2773 ms / plugin delta RSS 0 MB / plugin delta CPU 15 ms / OpenClaw import 59.3 ms / activate 0.4 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 11346   | p95WallMs regressed 791.3% over baseline   |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 755.4   | maxPeakRssMb regressed 690.3 over baseline |
