...
| Import loop                 | p50 1151 ms / p95 1165 ms / plugin delta RSS 0 MB / plugin delta CPU 0 ms / OpenClaw import 86.5 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 1930    | p95WallMs regressed 51.6% over baseline    |
| warn   | profile.peak-rss | maxPeakRssMb | 65.1     | 482.2   | maxPeakRssMb regressed 417.1 over baseline |
