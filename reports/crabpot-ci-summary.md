...
| Import loop                 | p50 2247 ms / p95 2300 ms / plugin delta RSS 6.9 MB / plugin delta CPU 0 ms / OpenClaw import 112.1 ms / activate 0.3 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------ |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 2605    | p95WallMs regressed 104.6% over baseline   |
