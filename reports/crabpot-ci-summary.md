...
| Import loop                 | p50 78 ms / p95 78 ms / plugin delta RSS 0.1 MB / plugin delta CPU 8 ms |
...
| ------ | ---------------- | ------------ | -------- | ------- | ------------------------------------------------------- |
| warn   | profile.wall-p95 | p95WallMs    | 1273     | 6462    | p95WallMs regressed 407.6% over baseline                |
