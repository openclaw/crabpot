...
| opik-openclaw          | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/opik-openclaw/dist/index.js                                     |
...
| bluebubbles            | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/bluebubbles/.crabpot-package/index.ts                           |
| bluebubbles            | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/bluebubbles/.crabpot-package/dist/index.js                      |
| bluebubbles            | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/bluebubbles/.crabpot-package/setup-entry.ts                     |
...
| memory-tencentdb       | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/memory-tencentdb/.crabpot-package/openclaw-plugin/dist/index.js |
...
| dingtalk-connector     | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/dingtalk-connector/dist/index.mjs                               |
| dingtalk-doc           | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/dingtalk-doc/dist/index.mjs                                     |
...
| yuanbao                | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/yuanbao/.crabpot-package/dist/index.js                          |
| yuanbao                | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/yuanbao/.crabpot-package/dist/setup-entry.js                    |
...
| telnyx-sms             | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/telnyx-sms/dist/setup-entry.js                                  |
