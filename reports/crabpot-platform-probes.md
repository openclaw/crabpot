...
| codex                  | sdk-alias-required | tsx     | jiti         | no          | no            | yes              | yes                | plugins/codex/.crabpot-package/index.ts                  |
| diagnostics-prometheus | ts-loader-required | tsx     | jiti         | no          | no            | yes              | yes                | plugins/diagnostics-prometheus/.crabpot-package/index.ts |
| google-meet            | sdk-alias-required | tsx     | jiti         | no          | no            | yes              | yes                | plugins/google-meet/.crabpot-package/index.ts            |
| diffs                  | sdk-alias-required | tsx     | jiti         | no          | no            | yes              | yes                | plugins/diffs/.crabpot-package/index.ts                  |
| memory-lancedb         | ts-loader-required | tsx     | jiti         | no          | no            | yes              | yes                | plugins/memory-lancedb/.crabpot-package/index.ts         |
| openclaw-qqbot         | sdk-alias-required | tsx     | jiti         | no          | no            | yes              | yes                | plugins/openclaw-qqbot/.crabpot-package/index.ts         |
| openclaw-qqbot         | sdk-alias-required | tsx     | jiti         | no          | no            | yes              | yes                | plugins/openclaw-qqbot/.crabpot-package/setup-entry.ts   |
| whatsapp               | sdk-alias-required | tsx     | jiti         | no          | no            | yes              | yes                | plugins/whatsapp/.crabpot-package/index.ts               |
| whatsapp               | sdk-alias-required | tsx     | jiti         | no          | no            | yes              | yes                | plugins/whatsapp/.crabpot-package/setup-entry.ts         |
