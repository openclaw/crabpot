...
| kitchen-sink           | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/kitchen-sink/src/index.js                                   |
| kitchen-sink           | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/kitchen-sink/src/index.js                                   |
| kitchen-sink           | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/kitchen-sink/src/setup.js                                   |
...
| openclaw-qqbot         | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/openclaw-qqbot/.crabpot-package/index.ts                    |
| openclaw-qqbot         | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/openclaw-qqbot/.crabpot-package/dist/index.js               |
| openclaw-qqbot         | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/openclaw-qqbot/.crabpot-package/setup-entry.ts              |
| whatsapp               | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/whatsapp/.crabpot-package/index.ts                          |
| whatsapp               | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/whatsapp/.crabpot-package/dist/index.js                     |
| whatsapp               | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/whatsapp/.crabpot-package/setup-entry.ts                    |
