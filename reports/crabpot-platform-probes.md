...
| google-meet            | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/google-meet/.crabpot-package/index.ts                           |
| google-meet            | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/google-meet/.crabpot-package/dist/index.js                      |
...
| openclaw-qqbot         | sdk-alias-required          | node    | -            | no          | no            | yes              | yes                | plugins/openclaw-qqbot/.crabpot-package/dist/setup-entry.js             |
