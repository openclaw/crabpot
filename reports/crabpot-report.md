...
| ------------------------- | ----- |
| Fixtures                  | 27    |
| High-priority fixtures    | 18    |
| Hard breakages            | 0     |
| Warnings                  | 51    |
| Compatibility suggestions | 92    |
| Issue findings            | 143   |
| P0 issues                 | 2     |
| P1 issues                 | 26    |
| Live issues               | 2     |
...
| yuanbao           | sdk-exports-present     | log   | all observed plugin SDK imports exist in target OpenClaw package exports              | openclaw/plugin-sdk, openclaw/plugin-sdk/account-id, openclaw/plugin-sdk/command-auth, openclaw/plugin-sdk/core, openclaw/plugin-sdk/matrix, openclaw/plugin-sdk/mattermost                                                                                                                                                                                                                                                        | -                         |
