...
- 🟡 P2 **codex** `deprecation-warning` `core-compat-adapter`
  ...
  - evidence:
    - [openclaw/plugin-sdk/session-store-runtime import @ conversation-binding-t0XMLz-j.js:21](https://github.com/openclaw/openclaw/blob/e085fa1a3ffd32d0ea6917e1e6fb4ecbffbb77d2/extensions/codex/dist/conversation-binding-t0XMLz-j.js#L21)
  - author remediation:
...
- 🟡 P2 **whatsapp** `deprecation-warning` `core-compat-adapter`
  ...
  - state: open · compat:none
  - evidence:
    - [openclaw/plugin-sdk/session-store-runtime import @ monitor-BVD90YEd.js:32](https://github.com/openclaw/openclaw/blob/e085fa1a3ffd32d0ea6917e1e6fb4ecbffbb77d2/extensions/whatsapp/dist/monitor-BVD90YEd.js#L32)
  - author remediation:
    - Replace deprecated loadSessionStore whole-store access with row-scoped session helpers.
    - docs: https://docs.openclaw.ai/clawhub/plugin-validation-fixes#sdk-load-session-store
